...
KNOWN_DANGLERS = {"wikilink", "wikilinks", "MEMORY", "context", "_session-log", "_Home"}
# add project-specific known-missing link targets via env CLAUDE_KNOWN_DANGLERS (comma-sep)
import os as _os
KNOWN_DANGLERS |= {x.strip() for x in _os.environ.get("CLAUDE_KNOWN_DANGLERS","").split(",") if x.strip()}
